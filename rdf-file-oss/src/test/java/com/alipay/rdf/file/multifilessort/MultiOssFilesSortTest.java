 ...
 */
public class MultiOssFilesSortTest {
    ...
    private static String                    ossPath         = "rdf/rdf-file/MultiOssFilesSortTest";
    ...
    public void testSortMultiFiles() throws Exception {
        ...
        fileStorage.upload(File.class.getResource("/multiFilesSort/de/data/").getPath(),
            ossFilePath, true);

        FileConfig fileConfig = new FileConfig("/multiFilesSort/de/de.json", storageConfig);
        // 设置排序
    ...
    public void testSortMultiFiles2_2() throws Exception {
        String ossFilePath = RdfFileUtil.combinePath(ossPath, "testSortMultiFiles2_2");
        fileStorage.upload(File.class.getResource("/multiFilesSort/de/data/").getPath(),
            ossFilePath, true);
        FileConfig fileConfig = new FileConfig(RdfFileUtil.combinePath(ossFilePath, "de1.txt"),
            "/multiFilesSort/de/de.json", storageConfig);
        // 设置排序
        fileConfig.setType(FileCoreToolContants.PROTOCOL_MULTI_FILE_SORTER);
    ...
    public void testSortMultiFiles4() throws Exception {
        String ossFilePath = RdfFileUtil.combinePath(ossPath, "testSortMultiFiles4");
        fileStorage.upload(File.class.getResource("/multiFilesSort/de/data/").getPath(),
            ossFilePath, true);
        FileConfig fileConfig = new FileConfig("/multiFilesSort/de/de.json", storageConfig);
        // 设置排序
